...
size_t eringbuffer_size(const eringbuffer_t *rb) { return rb->size; }

size_t eringbuffer_len(const eringbuffer_t *rb) { return rb->len; }

size_t eringbuffer_free(const eringbuffer_t *rb) { return rb->size - rb->len; }
...
size_t eringbuffer_write(eringbuffer_t *rb, const uint8_t *buffer,
                         size_t size) {
  size_t i;
  for (i = 0; i < size; ++i) {
